...
public class TerneraMovil {
	...
	public TerneraMovil(Long idTernera, int idMadre, int idPadre, String raza, String tipoDeParto,
			String caravanaTambo, String caravanaSnig, int pesoAlNacer, String fechaNacimiento, int id_guachera) {
		super();
